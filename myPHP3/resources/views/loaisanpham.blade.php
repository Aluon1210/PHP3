...
<div class="category-list px-2">
    <div class="section-title mb-4 border-bottom pb-2">
        <h2 class="h4 fw-bold m-0 text-uppercase" style="border-left: 5px solid var(--primary-blue); padding-left: 15px;">Danh mục loại sản phẩm</h2>
    </div>
            ...
            <div class="card h-100 border-0 shadow-sm overflow-hidden news-card">
                <div class="card-body p-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <a href="/loai-sp/{{ $loai->id }}" class="text-decoration-none small text-muted">Xem các sản phẩm <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
